...
class Version20171213224636 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE carts (id INTEGER NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE items (id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, image VARCHAR(2048) NOT NULL, description CLOB NOT NULL, price NUMERIC(99, 2) NOT NULL, PRIMARY KEY(id))');
    }
